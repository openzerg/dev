...
import { createZcpServer } from "../src/server.js"
import type { IZcpTool, GetContext } from "../src/tool.js"
...
describe("createZcpServer", () => {
  test("listTools returns all registered tools", async () => {
    const router = createZcpServer([mockTool, errorTool], mockGetContext)
